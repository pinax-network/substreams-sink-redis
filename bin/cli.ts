...
command.option('-H --redis-host <string>', 'Redis instance host', DEFAULT_REDIS_HOST);
command.option('-P --redis-port <string>', 'Redis instance port number', DEFAULT_REDIS_PORT);
